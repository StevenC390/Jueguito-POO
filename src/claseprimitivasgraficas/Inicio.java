...
public class Inicio extends javax.swing.JFrame {
    ...
    public Inicio() {
        ...
        this.player = new Imagen("src/Imagenes/rocket-league.png", 100, 100, 640/2, 360-50, 100,Color.BLACK,Color.BLACK, true, true, 1);
        this.bala= new Disparo(25,10, this.player.getX()+5, this.player.getY()-15,50, Color.black, Color.black, true, true, 2);
        this.enemigo1 = new Disparo(10, 30, this.nave.getX()-50, this.nave.getY(), 250, Color.blue, Color.green, true, true, 3);
        this.enemigo2 = new Disparo(10, 30, this.nave.getX()+150, this.nave.getY(), 250, Color.blue, Color.green, true, true, 3);
        ...
        this.lienzo1.getFiguras().add(enemigo2);
